...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for variable = CHG_DCHG_VAR
        ...
        for index = 1:length(CHG_DCHG_File_Name_Table)
            ...
            name1 = name1(name_index(end):name_index(end)+5); name1 = erase(name1, 'b');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for index = 1:length(Temp_File_Name_Table)
        ...
        name3 = erase(name3, 'Excel Test Data\CHG_DCHG\')
        name_index = find(name3=='T')+2;
        name4 = name3(name_index:name_index+5); name4 = erase(name4, 'T');
        name5 = string('Temp') ;
        name = name5+ name4 ; 
